...
\resizebox{\textwidth}{!}{%
	\begin{tabular}{|>{\centering\arraybackslash}m{0.1\linewidth}|>{\centering\arraybackslash}m{0.13\linewidth}|>{\centering\arraybackslash}m{0.1\linewidth}|>{\centering\arraybackslash}m{0.12\linewidth}|>{\centering\arraybackslash}m{0.1\linewidth}|>{\centering\arraybackslash}m{0.11\linewidth}|>{\centering\arraybackslash}m{0.11\linewidth}|>{\centering\arraybackslash}m{0.14\linewidth}|}
		...
		\textbf{\textit{2026 январь}}	&	\textbf{\textit{Южный Урал, Таганай}}	&	\textbf{\textit{лыжный}}	&	\textbf{\textit{лыжи}}	&	\textbf{\textit{82.3}}	& \textbf{\textit{7}} & \textbf{\textit{первая}} & \textbf{\textit{участие}} \\
		\hline	
	\end{tabular}%
}
